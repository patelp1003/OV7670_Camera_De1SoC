...
add_interface_port vga VGA_CMOS_DB cmos_db Input 8
add_interface_port vga VGA_CMOS_GND cmos_gnd Output 1
add_interface_port vga VGA_CMOS_HREF cmos_href Input 1
add_interface_port vga VGA_CMOS_PCLK cmos_pclk Input 1
add_interface_port vga VGA_CMOS_PWDN cmos_pwdn Output 1
add_interface_port vga VGA_CMOS_PWR cmos_pwr Output 1
add_interface_port vga VGA_CMOS_RST_N cmos_rst_n Output 1
add_interface_port vga VGA_CMOS_SCL cmos_scl Bidir 1
add_interface_port vga VGA_CMOS_SDA cmos_sda Bidir 1
add_interface_port vga VGA_CMOS_VSYNC cmos_vsync Input 1
add_interface_port vga VGA_CMOS_XCLK cmos_xclk Output 1
...
add_interface_port vga VGA_KEY key Input 4
add_interface_port vga VGA_LEDR ledr Output 10
